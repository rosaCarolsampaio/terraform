...
awslocal dynamodb put-item --table-name Music --item  file://src/script/itemTable.json  --return-consumed-capacity TOTAL 
awslocal dynamodb list-tables 
awslocal dynamodb query --table-name Music --key-conditions file://src/script/queryTable.json