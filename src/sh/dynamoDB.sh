...
awslocal dynamodb put-item --table-name Music --item  file://file://src/script/item_table.json  --return-consumed-capacity TOTAL 
awslocal dynamodb list-tables 
awslocal dynamodb query --table-name Music --key-conditions file://file://src/script/query_table.json